...
#     node1---(neta)---node2 --|             |  |______
#                              |             |         |
#                              |            (netd)     |__________(netg)
#                              |             |			    |	
#			       |---(netc)---node4 ---- (netf) -----node7
#
...
#--------node7--------------
echo ""
echo "Enable SR flags on router node7"
echo "--------------------------------------"
#enable IPV6 forwarding
$SSH_SD node7.$DOMAIN "sudo sysctl net.ipv6.conf.all.forwarding=1"
#enable SRH processing flag on node
$SSH_SD node7.$DOMAIN "sudo sysctl net.ipv6.conf.all.seg6_enabled=1"
#enable SRH processing flag on interface
$SSH_SD node7.$DOMAIN "sudo sysctl net.ipv6.conf.$n7_f_dev.seg6_enabled=1"
$SSH_SD node7.$DOMAIN "sudo sysctl net.ipv6.conf.$n7_g_dev.seg6_enabled=1"
